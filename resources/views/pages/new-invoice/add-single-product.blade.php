<tr id="gst_row_{{ $id }}">
    ...
    <td class="d-none">
        <input type="hidden" name="product_taxable_amt[]" id="taxable_amt_{{$id}}" class="form-control" value="0.00"  onkeyup="calculateTaxableAmt('{{$id}}')"/>
        <!-- Taxable Amt -->
    </td>
    <td>
        ...
        <div class="row d-none">
            <div class="col-lg-6">
                {{-- <input type="hidden" name="product_gst_rate[]" id="gst_rate{{$id}}" class="form-control" value="5.00"  onkeyup="calculateTaxableAmt('{{$id}}')"/> --}}
                <input type="hidden" name="product_cess_rate[]" id="cess_rate{{$id}}" class="form-control mt-1" value="0.00"  onkeyup="calculateTaxableAmt('{{$id}}')"/>        
            </div>
            <div class="col-lg-6">
                <input type="hidden" name="product_state_cess_rate[]" id="state_cess_rate{{$id}}" class="form-control" value="0.00"  onkeyup="calculateTaxableAmt('{{$id}}')"/>
                <input type="hidden" name="product_non_advol_rate[]" id="non_advol_rate{{$id}}" class="form-control mt-1" value="0.00"  onkeyup="calculateTaxableAmt('{{$id}}')"/>                
            </div>
        </div>
        <!-- Tax Rate -->
    </td>
    <td class="d-none">
        <input type="text" name="product_other_charges[]" id="other_charges_{{$id}}" class="form-control d-none" value="0.00" onkeyup="calculateTaxableAmt('{{$id}}')"/>
        <!-- Other Charges -->
    </td>
    <td class="d-none">
        <input type="text" name="product_total[]" id="total_{{$id}}" class="form-control d-none" value="0.00"/>
        <!-- Total -->
    </td>
    <td>
        <span
