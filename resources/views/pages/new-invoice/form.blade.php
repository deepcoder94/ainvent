<x-layout :currentPage="$currentPage">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th class="d-none">Taxable Amt</th>
                                    <th>Tax Rate</th>
                                    <th class="d-none">Other Charges</th>
                        ...
                        <table class="table table-bordered mt-3">
                            <thead>
                                <tr>
                                    <th class="d-none">Tax'ble Amt</th>
                                    <th class="d-none">CGST Amt | <br/>SGST Amt</th>
                                    <th class="d-none">IGST Amt</th>
                                    <th class="d-none">CESS Amt | <br/>State CESS</th>
                                    <th>Discount</th>
                                    <th class="d-none">Other Charges</th>
                                    <th>Round off Amt</th>
                                    <th class="d-none">Tot Inv. Amt</th>
                                </tr>    
                            </thead>
                            <tbody>
    ...
    @include('pages.new-invoice.add-single-product-modal')
    @include('pages.new-invoice.script')
</x-layout>
